...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(2), __webpack_require__(16).setImmediate))
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_vue_modaltor__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_vue_modaltor___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_vue_modaltor__);
//
//
//
//
...
__WEBPACK_IMPORTED_MODULE_1_vue__["a" /* default */].use(__WEBPACK_IMPORTED_MODULE_2_vue_modaltor___default.a);
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: {
    ...
    delpublicrival: function (nickname, index) {
      ...
      HTTP.post('delpublicrival/', bodyFormData, { headers: { 'Content-Type': 'application/vnd.api+json' } }).then(response => this.del_changestatus = response.data.data.status);
    },
    addpublicrival: function () {
      this.output = this.$refs.newpublic.value;
      var bodyFormData = new FormData();
      bodyFormData.set('public', this.output);
      HTTP.post('getavatar/', bodyFormData, { headers: { 'Content-Type': 'application/vnd.api+json' } }).then(response => this.profile_pic = response.data.data.status);
      HTTP.post('addpublicrival/', bodyFormData, { headers: { 'Content-Type': 'application/vnd.api+json' } }).then(response => this.add_changestatus = response.data.data.status);
      this.nicknames.push([this.output, this.profile_pic]);
    },
    getinforival: function (nickname) {
      var bodyFormData = new FormData();
      bodyFormData.set('username', nickname);
      HTTP.post('publicinfo', bodyFormData, { headers: { 'Content-Type': 'application/vnd.api+json' } }).then(response => this.rival_info = response.data.data);
    },
    direct: function (nickname, index_girls) {
      var bodyFormData = new FormData();
      bodyFormData.set('username', nickname);
      HTTP.post('direct', bodyFormData, { headers: { 'Content-Type': 'application/vnd.api+json' } }).then(response => this.direct_status = response.data.data.status);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Rival_vue__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Accounts_vue__ = __webpack_require__(37);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_vue_js_modal__ = __webpack_require__(39);
...
new __WEBPACK_IMPORTED_MODULE_0_vue__["a" /* default */]({
  el: '#rival',
  render: h => h(__WEBPACK_IMPORTED_MODULE_1__Rival_vue__["a" /* default */])
});
__WEBPACK_IMPORTED_MODULE_0_vue__["a" /* default */].use(__WEBPACK_IMPORTED_MODULE_3_vue_js_modal___default.a);

new __WEBPACK_IMPORTED_MODULE_0_vue__["a" /* default */]({
  el: '#accounts',
  render: h => h(__WEBPACK_IMPORTED_MODULE_2__Accounts_vue__["a" /* default */])
});
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Rival_vue__ = __webpack_require__(6);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_f51ee646_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Rival_vue__ = __webpack_require__(36);
...
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Rival_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_f51ee646_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Rival_vue__["a" /* default */],
...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('vue-modaltor',{attrs:{"visible":_vm.open_dm},on:{"hide":_vm.hideModal}},[_c('p',[_vm._v("Ошибка отправки сообщения")])]),_vm._v(" "),_c('div',{staticClass:"left-block"},[_c('form',{attrs:{"action":""}},[_c('input',{ref:"newpublic",attrs:{"type":"text"}}),_vm._v(" "),_c('button',{on:{"click":_vm.addpublicrival}},[_c('img',{attrs:{"src":"img/checkmark.png","alt":""}})])]),_vm._v(" "),_c('hr'),_vm._v(" "),_vm._l((_vm.nicknames),function(nickname,index){return _c('div',{staticClass:"ava-wrapper"},[_c('div',{staticClass:"smallstory"},[_c('div',{staticClass:"smallstory-wrapper"},[_c('img',{attrs:{"src":nickname[1]},on:{"click":function($event){return _vm.getinforival(nickname[0])}}})])]),_vm._v(" "),_c('p',[_vm._v("\n        "+_vm._s(nickname[0])+"\n      ")]),_vm._v(" "),_c('div',{staticClass:"delete"},[_c('img',{attrs:{"src":"img/icons8-minus-50.png","alt":""},on:{"click":function($event){return _vm.delpublicrival(nickname[0], index)}}})])])})],2),_vm._v(" "),_c('div',{staticClass:"right-block",staticStyle:{"margin-bottom":"15px"}},[_c('table',[_c('tbody',[_vm._m(0),_vm._v(" "),_vm._l((_vm.rival_info),function(girls,index_girls){return (girls['nickname_girl'] != 'error')?_c('tr',[_c('td',[_vm._v("\n            "+_vm._s(girls['created_time'])+"\n          ")]),_vm._v(" "),_c('td',[_vm._v("\n            "+_vm._s(girls['nickname_girl'])+"\n          ")]),_vm._v(" "),_c('td',{staticStyle:{"text-align":"center"}},[(girls['dm_status'] === false)?_c('img',{attrs:{"src":"img/cross.png","alt":""}}):_c('img',{attrs:{"src":"img/checkmark.png","alt":""}})]),_vm._v(" "),_c('td',[_vm._v("\n            "+_vm._s(girls['followers_girls'])+"\n          ")]),_vm._v(" "),_c('td',{staticStyle:{"border-right":"0"}},[_c('button',{on:{"click":function($event){return _vm.direct(girls['nickname_girl'], index_girls)}}},[_vm._v("\n              Отправить\n            ")])])]):_vm._e()})],2)])])],1)}
var staticRenderFns = [function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('tr',[_c('th',[_c('img',{attrs:{"src":"img/clock.png","alt":""}}),_vm._v("Date\n          ")]),_vm._v(" "),_c('th',{staticStyle:{"padding-right":"130px"}},[_c('img',{attrs:{"src":"img/user.png","alt":""}}),_vm._v("Nickname\n          ")]),_vm._v(" "),_c('th',[_c('img',{attrs:{"src":"img/mail.png","alt":""}}),_vm._v("Dialog\n          ")]),_vm._v(" "),_c('th',[_c('img',{attrs:{"src":"img/user-group.png","alt":""}}),_vm._v("Followers\n          ")]),_vm._v(" "),_c('th',{staticStyle:{"border-right":"0px"}},[_c('img',{attrs:{"src":"img/message.png","alt":""}}),_vm._v("Message\n          ")])])}]
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Accounts_vue__ = __webpack_require__(14);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_44570fa6_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Accounts_vue__ = __webpack_require__(38);
var normalizeComponent = __webpack_require__(5)
/* script */
...
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Accounts_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_44570fa6_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Accounts_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('vue-modaltor',{attrs:{"visible":_vm.open_status},on:{"hide":_vm.hideModal}},[_c('p',[_vm._v("Аккаунт успешно сменен")])]),_vm._v(" "),_vm._l((_vm.info),function(account){return _c('div',{staticClass:"ava-wrapper"},[_c('div',{staticClass:"smallstory"},[_c('div',{staticClass:"smallstory-wrapper"},[_c('img',{attrs:{"href":"changeaccount(account[0])","src":account[1],"alt":""}})])]),_vm._v(" "),_c('p',[_c('button',{staticClass:"button-top",on:{"click":function($event){return _vm.changeaccount(account[0])}}},[_vm._v(_vm._s(account[0]))])])])})],2)}
var staticRenderFns = []
var esExports = { render: render, staticRenderFns: staticRenderFns }
/* harmony default export */ __webpack_exports__["a"] = (esExports);
